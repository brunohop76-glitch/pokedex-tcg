...
export default function CatalogoLayout({ children }: { children: ReactNode }) {
  return (
    <div className="catalogo-route">
      {children}
      <style>{`
        /* CATÁLOGO D'MELO — visual isolado da rota /catalogo */
        .catalogo-route main { overflow-x: hidden !important; }

        /* HERO: compacto, horizontal e sem espaços artificiais */
        ...
        .catalogo-route main > section:nth-of-type(1) > div > div:first-child > p {
          display: block !important;
          width: auto !important;
        ...
        .catalogo-route main > section:nth-of-type(1) h1 {
          ...
          font-size: clamp(3.5rem, 6.3vw, 5.7rem) !important;
        ...
        /* FILTROS */
        .catalogo-route main > section:nth-of-type(2) {
        ...
        .catalogo-route main > section:nth-of-type(2) > div {
          width: min(1180px, 100%) !important;
          max-width: 1180px !important;
          margin: 0 auto !important;
          border: 2px solid #71816f !important;
        ...
        .catalogo-route main > section:nth-of-type(2) input:focus,
        .catalogo-route main > section:nth-of-type(2) select:focus {
        ...
        /* LISTA */
        .catalogo-route main > section:nth-of-type(3) {
          width: 100% !important;
          max-width: none !important;
          margin: 0 !important;
        ...
        @media (max-width: 800px) {
          ...
          .catalogo-route main > section:nth-of-type(1) > div { display: block !important; width: 100% !important; padding: 32px 0 !important; }
          .catalogo-route main > section:nth-of-type(1) h1 { font-size: clamp(2.9rem, 12vw, 4.5rem) !important; white-space: normal !important; }
          .catalogo-route main > section:nth-of-type(1) > div > div:last-child { width: 100% !important; min-width: 0 !important; margin-top: 22px !important; }
